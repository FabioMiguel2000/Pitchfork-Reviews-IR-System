...
df = df.rename(columns={"pub_date": "review_publication_date", "year": "song_release_year", "label": "record_label", "content":"review_content", "artist_x": "artist", "score": "rating_score"} )
